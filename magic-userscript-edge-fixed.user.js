...
const Container = class {
  ...
  loadCSS(css, name = 'CSS', useGM = true) {
    try {
      ...
      if (useGM && isGM) {
        const fn = (isFN(gm.addElement) && gm.addElement) || (typeof GM_addElement !== 'undefined' && isFN(GM_addElement) && GM_addElement);
